...
namespace ProyectoPav
{
    class PacienteHelper
    {
        ...
        public bool agregarPaciente(clsPaciente paci)
        {
            string str_sql = "INSERT INTO Pacientes (Nombre,Apellido,dni,Fecha_Nacimiento,Obra_Social,n_Afiliado,Domicilio,Telefono,Estado) values ";
